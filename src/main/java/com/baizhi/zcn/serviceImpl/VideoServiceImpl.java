...
import com.baizhi.zcn.entity.*;
import com.baizhi.zcn.po.VideoPo;
import com.baizhi.zcn.repository.VideoRepository;
import com.baizhi.zcn.service.VideoService;
import com.baizhi.zcn.util.AliyunOssUtil;
import com.baizhi.zcn.util.InterceptVideoPhotoUtil;
...
public class VideoServiceImpl implements VideoService {
    ...
    public void uploadVdieo(MultipartFile path, String id, HttpServletRequest request) {
         ...
         * */
        AliyunOssUtil.uploadFileBytes("yingx-186",path,"video/"+newName);


        //频接视频完整路径
        String netFilePath="https://yingx-186.oss-cn-beijing.aliyuncs.com/video/"+newName;
         ...
         * */
        AliyunOssUtil.uploadFile("yingx-186","photo/"+coverName,coverPath);
        ...
        video.setPath("https://yingx-186.oss-cn-beijing.aliyuncs.com/video/"+newName);
        video.setCover("https://yingx-186.oss-cn-beijing.aliyuncs.com/photo/"+coverName);
    ...
    public void uploadVdieos(MultipartFile path, String id, HttpServletRequest request) {
       ...
       * 视频截取  并上传至阿里云
        ...
        *   coverName：截取的封面名
       * */
        AliyunOssUtil.videoCoverIntercept("yingx-186","video/"+newName,"photo/"+coverName);
    ...
    public HashMap<String, Object> delete(Video video) {
        ...
        try {
             ...
             * */
            AliyunOssUtil.delete("yingx-186",videoName);
             ...
             *   fileName:文件名    目录名/文件名
             * */
            AliyunOssUtil.delete("yingx-186",coverName);
