...
public class AliyunOssUtil {
    ...
    private static String accessKeyId = "LTAI4Fft2pfxzwE2P2qLez3N";
    private static String accessKeySecret = "vfpqevOMfwxGPEX7PRSJ9T5a7FoZof";

    private static String bucket="yingx-186";
